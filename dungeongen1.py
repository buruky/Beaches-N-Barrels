import random
from Room import Room  # Ensure Room class is properly defined
...
class Generate:
    ...
    def generate_dungeon(self, level):
        ...
        grid[self.start_pos[0]][self.start_pos[1]] = Room("s ", self.start_pos[0] * 100, self.start_pos[1] * 100, 50, 50)  
        ...
        while queue and len(rooms) < num_rooms:
            ...
            for d in directions:
                ...
                grid[neighbor[0]][neighbor[1]] = Room("n ", neighbor[0] * 100, neighbor[1] * 100, 50, 50)  
   ...
   # """Loop over the grid and assign doors based on neighboring rooms."""
        directions = {
            "N": (0, -1),
            "S": (0, 1),
            "W": (-1, 0),
